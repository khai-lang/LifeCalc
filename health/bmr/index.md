...
<section class="bmr-seo">

  <h2>기초대사량(BMR)과 유지 칼로리(TDEE) 완벽 이해하기</h2>

  <p>
    기초대사량(BMR)은 아무것도 하지 않아도 생명을 유지하기 위해 소비되는 최소 에너지입니다.
    하지만 실제 체중 변화는 활동량이 포함된 <strong>TDEE(총 일일 에너지 소비량)</strong>를 기준으로 결정됩니다.
  </p>
...
<script>
  ...
  <ul>
    <li>✔ 체중 감량: TDEE - 300~500 kcal</li>
    <li>✔ 빠른 감량: TDEE - 500~700 kcal</li>
    <li>✔ 유지: TDEE 수준 유지</li>
  </ul>
