...
<div style="background:#f8f4ef; padding:22px; border-radius:10px; margin-bottom:32px; line-height:1.7;">
  ...
  <p>
    연봉이 실제로 얼마가 들어오는지, 4대보험이 어떻게 계산되는지, 퇴직금은 어떻게 산정되는지
    한눈에 정리한 급여·소득 계산 허브입니다. 2025년 기준 건강보험·고용보험율 변화,
    원천징수 방식, 근로소득 간이세액표 적용 등의 복잡한 규칙을 최신 기준으로 반영했습니다.
  </p>
  <p>
    이 페이지에서는 실수령액 계산부터 연봉↔시급 환산, 4대보험 공제액, 퇴직금 예상액까지
    일상에서 가장 많이 사용하는 급여 관련 계산을 빠르게 확인할 수 있습니다.
    각 계산기는 실제 근로 조건에 따라 변동되는 요소를 고려해 정확한 결과를 제공합니다.
  </p>
  <p>
    처음 급여 구조를 이해하려는 사회초년생부터, 연말에 소득 변동을 점검해야 하는 직장인까지
    누구나 쉽게 사용할 수 있도록 구성했으며, 아래 계산기를 통해 바로 확인하거나
    <a href="/lifelpus/">가이드 글</a>을 통해 개념을 먼저 살펴볼 수도 있습니다.
  </p>
</div>
